...
class VolumeFootprintEngine:
    ...
    # ===================================================================
    # 5. PREV - Price-Range Expansion Volume
    # ===================================================================
    ...
    # ===================================================================
    # 1. Tick Velocity (streaming-safe, no clustering)
    # ===================================================================
    def _tick_velocity(
        self,
        ticks: pd.DataFrame,
        candle_duration: str = '5min'
    ) -> pd.DataFrame:
        ...
        # --- Price binning (FIXED)
        price_step = 0.0001
        df['price_bin'] = (df['price'] / price_step).round() * price_step
        ...
        footprint = footprint.rename(columns={'price_bin': 'price'})
    ...
    # ===================================================================
    # Quick access for other modules
    # ===================================================================
